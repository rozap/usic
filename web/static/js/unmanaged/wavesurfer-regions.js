...
WaveSurfer.Region = {
    ...
    update: function(params, silent) {
        ...
        this.updateRender();
        if (!silent) this.fireEvent('update');
        if (!silent) this.wavesurfer.fireEvent('region-updated', this);
    },
